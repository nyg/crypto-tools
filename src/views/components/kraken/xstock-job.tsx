...
const settledPhases: string[] = ['done', 'error', 'cancelled', 'skipped']

export const isJobRunning = (job: XStockJob | null | undefined): boolean =>
   Boolean(job) && !terminalPhases.includes(job!.phase)

export const jobVerbs: Record<XStockJobKind, JobVerbs> = {
...
export function jobCounts(job: XStockJob | null | undefined) {
