...
export const defaultFilters: AggregateFilterValues = {
   pairKey: '', includeAllQuotes: false, from: null, to: null, order: 'asc'
}
...
export default function AggregateFilters({ filters, markets, onChange, onReset }: {
   ...
   const update = (changes: Partial<AggregateFilterValues>) => onChange({ ...filters, ...changes })

   const isFiltered = (Object.keys(defaultFilters) as (keyof AggregateFilterValues)[])
      ...
      <div className="space-y-3">
         <div className="grid grid-cols-2 gap-x-4 gap-y-3 md:grid-cols-4">
            ...
            <SelectField
               ...
               label="Order"
               value={filters.order}
               onValueChange={(value) => update({ order: value === 'desc' ? 'desc' : 'asc' })}
