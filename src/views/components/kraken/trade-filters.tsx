...
export const defaultFilters: TradeFilterValues = {
   pair: '', direction: '', ordertype: '', from: null, to: null, search: ''
}
...
export default function TradeFilters({ filters, options, onChange, onReset }: {
   ...
   options?: { pairs?: string[], directions?: string[], ordertypes?: string[] }
   ...
   const update = (changes: Partial<TradeFilterValues>) => onChange({ ...filters, ...changes })
