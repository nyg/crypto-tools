...
export default function XStockTable({
   ...
   onDescribe: (tickers: string[]) => void
   ...
   const toggle = (ticker: string) => setExpanded(current => {
                  ...
                  <TableRow key={listing.ticker}>
                     ...
                     <TableCell className="text-right tabular-nums">
                        {listing.volumeUsd24h === null
                           ...
                           : <span title={`${asRounded(Number(listing.volume24h))} units traded${listing.last ? ` · last ${asDollarAmount(listing.last)}` : ''}`}>
