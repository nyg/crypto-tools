const tradingPairs = {
   XXBTZUSD: { id: 'XXBTZUSD', name: 'XBT/USD', base: { decimals: 8 }, quote: { decimals: 2 } },
   XETHZUSD: { id: 'XETHZUSD', name: 'ETH/USD', base: { decimals: 8 }, quote: { decimals: 2 } },
   XXBTZEUR: { id: 'XXBTZEUR', name: 'XBT/EUR', base: { decimals: 8 }, quote: { decimals: 2 } },
   XETHZEUR: { id: 'XETHZEUR', name: 'ETH/EUR', base: { decimals: 8 }, quote: { decimals: 2 } },
   ADAUSD: { id: 'ADAUSD', name: 'ADA/USD', base: { decimals: 8 }, quote: { decimals: 6 } },
   DOTUSD: { id: 'DOTUSD', name: 'DOT/USD', base: { decimals: 8 }, quote: { decimals: 4 } },
   SOLUSD: { id: 'SOLUSD', name: 'SOL/USD', base: { decimals: 8 }, quote: { decimals: 4 } },
   XLTCZUSD: { id: 'XLTCZUSD', name: 'LTC/USD', base: { decimals: 8 }, quote: { decimals: 2 } },
   LINKUSD: { id: 'LINKUSD', name: 'LINK/USD', base: { decimals: 8 }, quote: { decimals: 4 } },
   MATICUSD: { id: 'MATICUSD', name: 'MATIC/USD', base: { decimals: 8 }, quote: { decimals: 6 } },
}
...
const closedOrders = {
   XXBTZUSD: {
      pair: { id: 'XXBTZUSD', name: 'XBT/USD', base: { decimals: 8 }, quote: { decimals: 2 } },
      buy: {
         orders: [
